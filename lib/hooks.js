...
export const useProfile = () => {
  ...
  const fetchProfile = useCallback(async () => {
    ...
    try {
      const { profileAPI, apiUtils } = await import('./api')
      ...
      if (profileResponse.success) {
        ...
        // On token expiry or auth error, clear token and continue as guest
        const msg = String(profileResponse.error || '').toLowerCase()
